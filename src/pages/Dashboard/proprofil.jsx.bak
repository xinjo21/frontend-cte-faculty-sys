  ...
  return (
    <Box bgColor='gray.50' borderRadius={25} p={5} >
      ...
      <Flex flexDirection={['column', 'row']}>
        ...
        <Box w={['100%', '25vw']}>
          <EditableTexts title='Birthdate' data='2018-07-22' inputType='date' /> {/* DATE PICKER PLEASE */}
...
function CollegeInformation() {
  ...
  return (
    <Box bgColor='gray.50' borderRadius={25} p={5}>
      ...
      <EditableTexts title='Employment Date' data='2018-07-22' inputType='date' />
    </Box>
  )
}
...
function SecurityCard() {
  return (
    <Box bgColor='gray.50' borderRadius={25} p={5}>
      ...
      <EditableTexts title="Email" data='template@gmail.com' />
      <EditableTexts title="Password" data='asdasdasd' inputType='password' />

    </Box>
  )
}

function EditableTexts({ data, title, inputType }) {
  ...
  return (
    <Editable value={data} isPreviewFocusable={true} selectAllOnFocus={false} type={inputType}>
      ...
      <Flex alignItems='baseline'>
        ...
        <Input as={EditableInput} type={inputType} m={2} />
        <EditableControls />
      </Flex>
    </Editable>
  )
